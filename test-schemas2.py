...
class TestV3Schemas(unittest.TestCase):
    ...
    def test_wikidata_entityschemas(self) -> None:
        ...
        for schema in entity_schemas:
            with self.subTest(schema=schema):
                ...
                response = self.app.get(f'/api/v3?entityschema={schema}&entity=Q100532807&language=en',
                                        follow_redirects=True)
    ...
    def test_entityschema_e3(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E3&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e121(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E121&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e126(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E126&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)

    def test_entityschema_e135(self):
        """
        Tests that schemas with a single statement do not fail

        This test tests entityschema E135 against entity Q85396849 (Drumlohan).
        The schema contains 1 statement. The test makes sure that this still returns a 200 response
        """
        response = self.app.get('/api/v3?entityschema=E135&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e176(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E176&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e187(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E187&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e228(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E228&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e236(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E236&entity=Q1728820&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e239(self):
        ...
        The schema is blank. The test makes sure that this still returns a 200 response
        """
        response = self.app.get('/api/v3?entityschema=E239&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e247(self):
        ...
        The schema is blank. The test makes sure that this still returns a 200 response
        """
        response = self.app.get('/api/v3?entityschema=E247&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e275(self):
        ...
        that this still returns a 200 response
        """
        response = self.app.get('/api/v3?entityschema=E275&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e278(self):
        ...
        """
        response = self.app.get('/api/v3?entityschema=E278&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)
    ...
    def test_entityschema_e340(self):
        """
        Tests that shapes containing an OR do not fail

        This test tests entityschema E340 against entity Q85396849 (Drumlohan).
        The schema contains a OR statement. The test makes sure that this still returns a 200 response
        """
        response = self.app.get('/api/v3?entityschema=E340&entity=Q85396849&language=en',
                                follow_redirects=True)
        self.assertEqual(200, response.status_code)

    def test_entityschema_e349(self):
        """
        Tests that schemas with qualifiers and references do not fail

        This test tests entityschema E349 against entity Q85396849 (Drumlohan).
        The schema contains qualifiers and references. The test makes sure that this still returns a 200 response
        """
    ...
    def test_entityschema_e351(self):
        """
        Tests that a property returns "incorrect"
